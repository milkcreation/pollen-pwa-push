...
<body class="PwaPushTester">
<div class="PwaPushTester-container">
    <div class="PwaPushTester-icon">
    ...
    <h1 class="PwaPushTester-title">
        <?php echo $this->get('PwaPushTester.l10n.title'); ?>
    </h1>

    <button id="PwaPushTester-button--subscribe" class="PwaPushTester-button" type="button">
        <?php echo $this->get('PwaPushTester.l10n.button_default'); ?>
    </button>

    <button id="PwaPushTester-button--send" class="PwaPushTester-button" type="button">
