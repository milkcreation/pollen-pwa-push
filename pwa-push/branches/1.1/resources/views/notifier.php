...
<body class="PwaPushNotifier">
<div class="PwaPushNotifier-container">
    <div class="PwaPushNotifier-icon">
    ...
    <h1 class="PwaPushNotifier-title">
        <?php echo $this->get('PwaPushNotifier.l10n.title'); ?>
    </h1>

    <form id="PwaPushNotifier-form" method="post" action="">
        <div class="PwaPushNotifier-formRow">
            <input
                    type="text"
                    class="PwaPushNotifier-formControl PwaPushNotifier-formControl--text"
                    name="title"
        ...
        <div class="PwaPushNotifier-formRow">
            <textarea
                    class="PwaPushNotifier-formControl PwaPushNotifier-formControl--textarea"
                    name="body"
        ...
        <div class="PwaPushNotifier-formRow">
            <button class="PwaPushNotifier-button" type="submit">Envoyer</button>
        </div>
    </form>
